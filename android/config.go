...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Banana.Specific_camera_parameter_library)
}
...
func (c *deviceConfig) QTIAudioPath() string {
	return String(c.config.productVariables.Banana.QTIAudioPath)
}

func (c *deviceConfig) QTIDisplayPath() string {
	return String(c.config.productVariables.Banana.QTIDisplayPath)
}

func (c *deviceConfig) QTIMediaPath() string {
	return String(c.config.productVariables.Banana.QTIMediaPath)
}
